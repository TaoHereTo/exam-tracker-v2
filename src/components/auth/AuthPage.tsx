...
export function AuthPage({ initialView }: AuthPageProps) {
    ...
    // Determine if we need to show BentoGrid based on pathname
                    ...
                    <div className="space-y-4">
                        {pathname === '/auth/signup' ? (
                            ...
                            <FormTransitionWrapper currentPath={pathname} className="w-full">
                                <MagicCard className="rounded-xl w-full overflow-visible" gradientSize={240} gradientColor="rgba(0, 0, 0, 0.08)" gradientOpacity={0.5}>
                                    <div className="w-full p-6 sm:p-8">
