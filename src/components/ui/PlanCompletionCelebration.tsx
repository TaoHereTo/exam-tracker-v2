...
export const PlanCompletionCelebration: React.FC<PlanCompletionCelebrationProps> = ({
  isOpen,
  onClose,
  onViewPlans,
  planName
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      {/* 主弹窗 */}
      <div className={cn(
        "relative bg-white dark:bg-[#171717] rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 text-center transform transition-all duration-500",
