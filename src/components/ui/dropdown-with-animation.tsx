  ...
  return (
    <DropdownMenuPortal>
      <DropdownMenuPrimitive.SubContent
        ref={ref}
        className={cn(
          "z-[var(--z-dropdown)] min-w-[8rem] max-h-[20rem] overflow-y-auto scrollbar-hide rounded-xl p-1 shadow-lg",
...
>(function DropdownMenuContent({ className, sideOffset = 4, portal = true, ...props }, ref) {
  const content = (
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[var(--z-dropdown)] min-w-[8rem] max-h-[20rem] overflow-y-auto scrollbar-hide rounded-xl p-1 shadow-md",
        "bg-white dark:bg-black",
        "text-black dark:text-white",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        className
