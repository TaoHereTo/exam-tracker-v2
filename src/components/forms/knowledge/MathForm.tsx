...
const MathForm: React.FC<MathFormProps> = ({ onAddKnowledge }) => {
    ...
    return (
        <Card className="max-w-md mx-auto">
            <CardHeader>
                <CardTitle>录入 - 数量关系</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    <Label htmlFor="type">类型</Label>
                    <Input id="type" type="text" placeholder="例如：数学技巧" value={type} onChange={e => setType(e.target.value)} />
                </div>
                <div className="space-y-2">
