...
export function AdvancedSetting() {
    ...
    return (
        <>
            ...
            <Card className="mt-6">
                <CardHeader>
                    <CardTitle><MixedText text="数据概览动画" /></CardTitle>
                    <CardDescription><MixedText text="关闭后，数据概览中的卡片将以静态列表展示，不再滚动动画。" /></CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div>
                            <h3 className="font-medium"><MixedText text="启用滚动动画" /></h3>
                            <p className="text-sm text-muted-foreground"><MixedText text="控制数据概览卡片是否进行滚动动画展示。" /></p>
                        </div>
                        <Switch checked={overviewAnimate} onCheckedChange={setOverviewAnimate} />
                    </div>
                </CardContent>
            </Card>
            {/* 存储管理 */}
