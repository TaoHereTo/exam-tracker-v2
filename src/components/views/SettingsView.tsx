...
import { Cloud, Download, Upload, Eye } from "lucide-react";
                ...
                <Card className="mt-6">
                    ...
                    <CardContent>
                        <div className="flex items-center justify-between p-4 border border-destructive/50 rounded-lg bg-destructive/5">
                            <div>
                                <h3 className="font-medium text-destructive"><MixedText text="清空所有数据" /></h3>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        <AlertDialogTitle><MixedText text="您确定要这么做吗？" /></AlertDialogTitle>
